...
def transform_load_green(service, year):
    ...
    """
    The `transform_load_green` function reads and processes monthly parquet files for green taxi data,
    ...
    processed. In this case, it is expected to be a string indicating the service type, with 'green'
    ...
    logger = spark._jvm.org.apache.log4j.LogManager.getLogger("transform_load_green")
    ...
    for month in range(1, 13):
        ...
        try:
            ...
            df.write.format("bigquery")\
                ...
                .save("indigo-muse-452811-u7.project_dataset.staging_table_green")
...
def main():
    ...
    if args.service.lower() != 'green':
        raise ValueError("Currently, only 'green' service is supported.")

    transform_load_green(args.service, args.year)
